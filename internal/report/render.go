...
<h2>Minimization</h2><p>{{.Minimization.Status}} ({{.Minimization.Minimality}}), events {{.Minimization.OriginalEvents}} to {{.Minimization.FinalEvents}}, actions {{.Minimization.OriginalActions}} to {{.Minimization.FinalActions}}.</p></body></html>
`))
